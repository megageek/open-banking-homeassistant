# Getting Started with Nordigen for Home Assistant

This guide will help you install and set up the Nordigen for Home Assistant custom integration for Home Assistant.
...
5. Add this repository URL: `https://github.com/megageek/open-banking-homeassistant`
6. Set category to "Integration"
7. Click "Add"
8. Find "Nordigen for Home Assistant" in the integration list
9. Click "Download"
10. Restart Home Assistant

### Manual Installation

1. Download the latest release from the [releases page](https://github.com/megageek/open-banking-homeassistant/releases)
2. Extract the `nordigen` folder from the archive
3. Copy it to `custom_components/nordigen/` in your Home Assistant configuration directory
...
4. Select entities from "Nordigen for Home Assistant"
...
- Report issues at [GitHub Issues](https://github.com/megageek/open-banking-homeassistant/issues)

## Support

For help and discussion:

- [GitHub Discussions](https://github.com/megageek/open-banking-homeassistant/discussions)
