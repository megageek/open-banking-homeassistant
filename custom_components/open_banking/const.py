...
CONF_TRANSACTION_STORAGE = "transaction_storage"

TRANSACTION_STORAGE_DISABLED = "disabled"
TRANSACTION_STORAGE_MEMORY = "memory"
TRANSACTION_STORAGE_ENCRYPTED = "encrypted"
DEFAULT_TRANSACTION_STORAGE = TRANSACTION_STORAGE_DISABLED
TRANSACTION_RETENTION_DAYS = 90
TRANSACTION_MAX_RECORDS = 5000
TRANSACTION_CACHE_FORMAT_VERSION = 1
