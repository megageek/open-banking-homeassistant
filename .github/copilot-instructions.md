...
- `entity/` — Base entity class (`NordigenEntity`)
...
- Entity MRO: `(PlatformEntity, NordigenEntity)` — order matters
...
- Debug level: `custom_components.nordigen: debug` in `config/configuration.yaml`
