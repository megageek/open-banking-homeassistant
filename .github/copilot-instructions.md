...
- `entity/` — Base entity class (`OpenBankingEntity`)
...
- Entity MRO: `(PlatformEntity, OpenBankingEntity)` — order matters
...
- Debug level: `custom_components.open_banking: debug` in `config/configuration.yaml`
