...
from custom_components.open_banking.config_flow import (
    NordigenConfigFlow,
    create_req,
    get_institutions,
    valid_country,
...
class TestConfigFlowGetRequisition:
    @unittest.mock.patch("custom_components.open_banking.config_flow.create_req")
    @pytest.mark.asyncio
    async def test_get_requisition_ex(self, mocked_create_req):
        ...
        result = await inst.get_requisition(
            requisitions=mocked_requisitions,
