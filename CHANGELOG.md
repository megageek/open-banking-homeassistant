...
## [0.6.0](https://github.com/megageek/open-banking-homeassistant/compare/v0.5.0...v0.6.0) (2026-07-18)


### ⚠ BREAKING CHANGES

* **translations:** connection status sensor values now use lowercase requisition codes.
* **coordinator:** bank subentries now store active-window scheduling fields instead of refresh_interval; existing subentries must be reconfigured.
...
* **brand:** add dark-mode integration icons ([811cb27](https://github.com/megageek/open-banking-homeassistant/commit/811cb276993d5317dd21357fc2d58a948589be50))
* **brand:** add Open Banking integration icons ([df6e764](https://github.com/megageek/open-banking-homeassistant/commit/df6e7645c0044394a79f84102ec76b690ce7ce71))
* **config-flow:** expose sandbox institution ([54b9ab6](https://github.com/megageek/open-banking-homeassistant/commit/54b9ab669dfda7420c90598ec5d3de19d86f2594))
...
* **coordinator:** add quota-aware refresh scheduling ([8e1dc9a](https://github.com/megageek/open-banking-homeassistant/commit/8e1dc9a1973fbd3d2a4b3eef27c546b503f8fe13))
...
* harden integration lifecycle and diagnostics ([cfcb02a](https://github.com/megageek/open-banking-homeassistant/commit/cfcb02a48c433b02b4ae7848dec964cac9f64568))
...
* **repairs:** renew expiring bank requisitions ([2643469](https://github.com/megageek/open-banking-homeassistant/commit/264346925af839a2f46837a1f44d6913bb30efe4))
...
* **sensor:** expose bank refresh timestamps ([a5e2877](https://github.com/megageek/open-banking-homeassistant/commit/a5e28776032aab669a0d53d92a4898aa8ef35348))
* **sensor:** show masked account identifiers ([77e86fe](https://github.com/megageek/open-banking-homeassistant/commit/77e86fe6e30f904c7de0368cba2a0242a00b3033))
...
* **config-flow:** clarify bank connection settings ([497db10](https://github.com/megageek/open-banking-homeassistant/commit/497db100de3d06825c55170909b7cac466466110))
* **config-flow:** initialize authorization callbacks ([312c23b](https://github.com/megageek/open-banking-homeassistant/commit/312c23b3aec958e9cdf5caafe288b3befa095a1c))
...
* **devcontainer:** activate Home Assistant for hassfest ([9a57cf2](https://github.com/megageek/open-banking-homeassistant/commit/9a57cf2c1bbceee6981ebc1577256326937d3643))
...
* **devcontainer:** load local env in terminal sessions ([7df182a](https://github.com/megageek/open-banking-homeassistant/commit/7df182a8f41875dfafbe731ec3867f078eed870c))
...
* **sensor:** discover and distinguish bank accounts ([4e0e088](https://github.com/megageek/open-banking-homeassistant/commit/4e0e0883bb82e7f3386fb247974013753d19f556))
...
* stop coordinators when unloading entry ([822ab85](https://github.com/megageek/open-banking-homeassistant/commit/822ab85a5da9475788529b1a22857443f37ca46b))
* **tests:** use project venv for test tooling ([6e04064](https://github.com/megageek/open-banking-homeassistant/commit/6e0406469502116d8963c5c839e53fd99bf68dc4))
* **translations:** comply with hassfest schema ([9c853a5](https://github.com/megageek/open-banking-homeassistant/commit/9c853a5e00d627aa899f006b7e74efc146315512))
